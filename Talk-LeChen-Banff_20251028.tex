...
\begin{frame}[noframenumbering] % Title page.
  \titlepage
\end{frame}
\begin{frame}[fragile] % Three deposition models side-by-side (no overlays)
  \frametitle{How do surfaces grow?}

  \begin{columns}[T,onlytextwidth]
    \column{0.32\textwidth}
    \centering
    {\footnotesize Random deposition}\par\vspace{0.3em}
    \resizebox{\linewidth}{!}{%
    ...
    \centering
    {\footnotesize RD with surface relaxation}\par\vspace{0.3em}
    \resizebox{\linewidth}{!}{%
      \begin{tikzpicture}[every node/.style={draw, minimum size=1cm}, node distance=0cm]
        \tikzset{
          solidnode/.style={
    ...
    \column{0.32\textwidth}
    \centering
    {\footnotesize Ballistic deposition}\par\vspace{0.3em}
    \resizebox{\linewidth}{!}{%
      \begin{tikzpicture}[every node/.style={draw, minimum size=1cm}, node distance=0cm]
        \tikzset{
          solidnode/.style={
