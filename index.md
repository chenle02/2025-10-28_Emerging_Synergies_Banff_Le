---
title: Analysis of Tetris Ballistic Deposition and the Robustness of the KPZ Universality Class
---

<!-- Enable MathJax on GitHub Pages for inline $...$ and display $$...$$ math -->
<script>
  window.MathJax = {
    tex: {
      inlineMath: [['$', '$'], ['\\(', '\\)']],
  ...
  // Optional: defer typeset until page load
