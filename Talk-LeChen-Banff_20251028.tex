...
\begin{frame}[t]{Random Deposition (one drop per time step)}
  ...
  \medskip \textbf{Single–column law.} After $t$ drops total,
  \[
  ...
  \medskip
  \textbf{Width (variance decomposition).} By i.i.d.\ columns,
  \[
  ...
  and
  \[
    \boxed{\,W(L,t)\;\sim\;\left(1-\frac1L\right)\;\left(\frac{t}{L}\right)^{1/2}\,}
  \]

  \medskip \alert{Scaling.} Growth exponent \(\beta = \tfrac12\):
