...
\begin{frame} % Tetromino overview
  ...
  \begin{center}
    ...
    \begin{tabular}{cccc}
      \includegraphics[height=0.95cm]{tetromino/Tetromino_1x1_Single.png} &
      \includegraphics[height=0.95cm]{tetromino/Tetromino_I_Vertical.png} &
      \includegraphics[height=0.95cm]{tetromino/Tetromino_O_Single.png} &
      \includegraphics[height=0.95cm]{tetromino/Tetromino_T_Up.png} \\
      {\small 1x1} & {\small I (Vertical)} & {\small O (2x2)} & {\small T (Up)} \\
      \includegraphics[height=0.95cm]{tetromino/Tetromino_S_Horizontal.png} &
      \includegraphics[height=0.95cm]{tetromino/Tetromino_Z_Horizontal.png} &
      \includegraphics[height=0.95cm]{tetromino/Tetromino_J_Up.png} &
      \includegraphics[height=0.95cm]{tetromino/Tetromino_L_Up.png} \\
      {\small S (Horiz)} & {\small Z (Horiz)} & {\small J (Up)} & {\small L (Up)} \\
    \end{tabular}
  \end{center}

  \vspace{0.6em} {\footnotesize Sticky pieces are shown (non-bordered).
  Non-sticky variants use bordered images with the same names plus the suffix
\texttt{\_bordered}. All orientations are available for I, J, L, T, S, Z; O is a
2x2 square; 1x1 is an extra single-site piece.}
\end{frame}
...
\end{frame}
\begin{frame} % Surface growth -- Cell
  % \frametitle{Off-lattice Eden model}
  ...
  \myFootCite{santalla.ferreira:18:eden}
\end{frame}
...
\begin{frame}[fragile] % References
  ...
  \RefGroup{Main References$^*$}{
    \nocite{conus.joseph.ea:13:on}
    \nocite{zel-dovich.ruzmauikin.ea:90:almighty}
    \nocite{chen.xia:23:asymptotic}
    \nocite{zel-dovich.molchanov.ea:87:self-excitation}
    % \nocite{chen.huang:19:comparison}
    % \nocite{aaronson:97:introduction}
  }
